...
" Read the RSL syntax to start with
if version < 600
  so <sfile>:rsl/rsl.vim
endif
...
syn keyword rslDef record variable field report var query string nodef libstruct rrformat style submission screen query
syn keyword rslDef popformat pushformat main include
syn keyword rslFun decode balance sum 

syn keyword sqlType	field prec 
" The SQL reserved words, defined as keywords.

syn keyword sqlSpecial  false null true xtype space
...
if version >= 508 || !exists("did_sql_syn_inits")
  ...
  HiLink sqlType	Type
  HiLink sqlTodo	Todo
  HiLink rslFun Function
  HiLink rslDef Identifier
  delcommand HiLink
endif
